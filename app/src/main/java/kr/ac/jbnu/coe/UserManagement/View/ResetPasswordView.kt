...
class ResetPasswordView : AppCompatActivity(), View.OnClickListener{
    ...
    fun showDialog(title : String, contents : String){
        val dlg: AlertDialog.Builder = AlertDialog.Builder(this@ResetPasswordView,  android.R.style.Theme_DeviceDefault_Light_Dialog_NoActionBar_MinWidth)
