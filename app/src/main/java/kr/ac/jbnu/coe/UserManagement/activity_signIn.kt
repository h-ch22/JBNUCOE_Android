...
class activity_signIn : AppCompatActivity(), View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        auto = (context as activity_signIn).getSharedPreferences("signIn Information", Activity.MODE_PRIVATE)
    ...
    override fun onClick(v: View?) {
        if (v != null) {
            ...
            if(v.getId() == R.id.btn_resetPassword){
                val intent = Intent(this, activity_resetPassword::class.java)
                startActivity(intent)
                finish()
            }
        }
    ...
    fun showDialog(title : String, contents : String){
        val dlg: AlertDialog.Builder = AlertDialog.Builder(this@activity_signIn,  android.R.style.Theme_DeviceDefault_Light_Dialog_NoActionBar_MinWidth)
