...
class activity_license : AppCompatActivity(), View.OnClickListener{
    ...
    fun showDialog(){
        val dlg: AlertDialog.Builder = AlertDialog.Builder(this@activity_license,  android.R.style.Theme_DeviceDefault_Light_Dialog_NoActionBar_MinWidth)
        ...
        dlg.setPositiveButton("동의", DialogInterface.OnClickListener { dialog, which ->
            val intent = Intent(this, activity_insertUserInfo::class.java)
