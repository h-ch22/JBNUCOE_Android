...
class InsertUserInfoView : AppCompatActivity(), View.OnClickListener{
                ...
                if(email != "" && password != "" && checkPassword != "" && name != "" && phone != ""){
                    if(password!!.length < 6){
                        ...
                        if(!password.equals(checkPassword)){
                            ...
                            val intent = Intent(this, CheckAcademicView::class.java)
    ...
    fun showDialog(title : String, contents : String){
        val dlg: AlertDialog.Builder = AlertDialog.Builder(this@InsertUserInfoView,  android.R.style.Theme_DeviceDefault_Light_Dialog_NoActionBar_MinWidth)
        dlg.setTitle(title)
